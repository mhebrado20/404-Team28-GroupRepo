...
byte  parseDemodBitQueue( bool inBit ) {
  ...
  if (  call.byteWorkBitIndex == 0 ) { // start bit
    ...
    if ( call.dataByteCount == 0 ) {
      ...
      if ( call.byteWork == 0x80 )  recordFormat = MDMF ;
      else  {
